...
function base(baseFormat: string | boolean) {
  const date = new Date();
  if (!baseFormat)
    return `${config.White}[${date.getFullYear()}-${
      date.getMonth() + 1
    }-${date.getDate()}]${config.Reset}`;
  let complete: string = "";
...
export class Logger {
  ...
  error(message: string, options?: OverwriteOptions) {
    ...
    if (!this.colors.error && !options.color)
      throw new Error("Error color is not found");
    if (!this.symbols.left && options.symbols.left)
      throw new Error("Left symbol not found");
    if (!this.symbols.right && options.symbols.right)
      throw new Error("Right symbol not found");
    let res;
    ...
    console.log(
      base(this.format) +
        `${options.color ? options.color : this.colors.error} ${
          options.symbols.left ? options.symbols.left : this.symbols.left
        }${options.title ? options.title : "Error"}${
          options.symbols.right ? options.symbols.right : this.symbols.right
        }${config.Reset} — ${res}${message}${config.Reset}`
    );
  }
  /**
   * @param {string} message The message you want to display
  ...
  info(message: string, options?: OverwriteOptions) {
    ...
    if (!options.symbols) options.symbols = { left: false, right: false };
    if (!this.colors.info && !options.color)
      throw new Error("Info color is not found");
    if (!this.symbols.left && options.symbols.left)
      throw new Error("Left symbol not found");
    if (!this.symbols.right && options.symbols.right)
      throw new Error("Right symbol not found");
    ...
    console.log(
      base(this.format) +
        `${options.color ? options.color : this.colors.info} ${
          options.symbols.left ? options.symbols.left : this.symbols.left
  ...
  success(message: string, options?: OverwriteOptions) {
    ...
    if (!options.symbols) options.symbols = { left: false, right: false };
    if (!this.colors.success && !options.color)
      throw new Error("Success color is not found");
    if (!this.symbols.left && options.symbols.left)
      throw new Error("Left symbol not found");
    if (!this.symbols.right && options.symbols.right)
      throw new Error("Right symbol not found");
    ...
    console.log(
      base(this.format) +
        `${options.color ? options.color : this.colors.success} ${
          options.symbols.left ? options.symbols.left : this.symbols.left
  ...
  debug(message: string, options?: OverwriteOptions) {
    ...
    if (!options.symbols) options.symbols = { left: false, right: false };
    if (!this.colors.debug && !options.color)
      throw new Error("Debug color is not found");
    if (!this.symbols.left && options.symbols.left)
      throw new Error("Left symbol not found");
    if (!this.symbols.right && options.symbols.right)
      throw new Error("Right symbol not found");
    ...
    console.log(
      base(this.format) +
        `${options.color ? options.color : this.colors.debug} ${
          options.symbols.left ? options.symbols.left : this.symbols.left
        }${options.title ? options.title : "Debug"}${
          options.symbols.right ? options.symbols.right : this.symbols.right
        }${config.Reset} — ${res}${message}${config.Reset}`
    );
  }
  ...
  warn(message: string, options?: OverwriteOptions) {
    ...
    if (!options.symbols) options.symbols = { left: false, right: false };
    if (!this.colors.warn && !options.color)
      throw new Error("Warn color is not found");
    if (!this.symbols.left && options.symbols.left)
      throw new Error("Left symbol not found");
    if (!this.symbols.right && options.symbols.right)
      throw new Error("Right symbol not found");
    ...
    console.log(
      base(this.format) +
        `${options.color ? options.color : this.colors.warn} ${
          options.symbols.left ? options.symbols.left : this.symbols.left
        }${options.title ? options.title : "Warn"}${
          options.symbols.right ? options.symbols.right : this.symbols.right
        } ${config.Reset}— ${res}${message}${config.Reset}`
    );
  }
