...
function main(message: string, logger: Transformer, name: string, overwrite?: Overwrite) {
...
export class Transformer {
    ...
    public setDate(date: string): Transformer {
        this.date = date;
        return this;
    }
    public info(message: string, overwrite?: Overwrite): string {
        return main(message, this, "Info",overwrite)
    }
    public fatal(message: string, overwrite?: Overwrite): string {
        return main(message, this, "Fatal",overwrite)
    }
    public error(message: string, overwrite?: Overwrite): string {
        return main(message, this, "Error",overwrite)
    }
    public debug(message: string, overwrite?: Overwrite): string {
        return main(message, this, "Debug",overwrite)
    }
}